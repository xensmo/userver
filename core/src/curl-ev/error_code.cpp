...
public:
    ...
    [[nodiscard]] const char* name() const noexcept override { return "curl-easy"; }
...
public:
    ...
    [[nodiscard]] const char* name() const noexcept override { return "curl-multi"; }
...
public:
    ...
    [[nodiscard]] const char* name() const noexcept override { return "curl-share"; }
...
public:
    ...
    [[nodiscard]] const char* name() const noexcept override { return "curl-url"; }
...
public:
    ...
    [[nodiscard]] const char* name() const noexcept override { return "userver-curl-ratelimit"; }
