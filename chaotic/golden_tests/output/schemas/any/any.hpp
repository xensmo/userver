...
WithAnyField Parse(USERVER_NAMESPACE::formats::json::Value json, USERVER_NAMESPACE::formats::parse::To<WithAnyField>);

WithAnyField Parse(USERVER_NAMESPACE::formats::yaml::Value json, USERVER_NAMESPACE::formats::parse::To<WithAnyField>);

WithAnyField Parse(USERVER_NAMESPACE::yaml_config::Value json, USERVER_NAMESPACE::formats::parse::To<WithAnyField>);
...
USERVER_NAMESPACE::formats::json::Value Serialize(
    const WithAnyField& value, USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>);

void WriteToStream(const ::ns::WithAnyField& value, USERVER_NAMESPACE::formats::json::StringBuilder& sw,
